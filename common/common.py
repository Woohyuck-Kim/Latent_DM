...
def parse_args(default=False):
    ...
    parser.add_argument('--model', help='Model', default='resnet18',
    ...
    parser.add_argument('--load_path', help='Path to the loading checkpoint',
                        default='./resnet18/cifar10_unlabeled.model', type=str)
    ...
    parser.add_argument("--ood_layer", help='layer for OOD scores',
                        choices=['penultimate', 'simclr', 'shift', 'feature'],
                        default=['simclr', 'shift', 'feature'], nargs="+", type=str)
    ...
    parser.add_argument("--config",
                        default="./ configs / subvp / cifar10_ddpm_continuous.py", type=str)
