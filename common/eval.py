...
test_loader = DataLoader(test_set, shuffle=True, batch_size=P.test_batch_size, **kwargs)
...
if P.ood_dataset is None:
    if P.one_class_idx is not None:
        ...
        P.ood_dataset = ['svhn', 'lsun_resize', 'cifar100', 'imagenet_resize']
...
for ood in P.ood_dataset:
    ...
    ood_test_loader[ood] = DataLoader(ood_test_set, shuffle=True, batch_size=P.test_batch_size, **kwargs)
...
loaded_state = torch.load('./checkpoints/checkpoint_CSI_fine_uniform(-1, 1)_13.pth', map_location=torch.device('cuda'))
