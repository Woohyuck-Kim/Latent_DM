...
from utils_1.utils import AverageMeter, normalize
...
def train(P, epoch, model, criterion, optimizer, scheduler, loader, logger=None,
          simclr_aug=None, linear=None, linear_optim=None, help_ood=None, help=False):
    ...
    for n, (images, labels) in enumerate(loader):
        ...
        sim_matrix = get_similarity_matrix(simclr, multi_gpu=P.multi_gpu, help_ood=help_ood)
        loss_sim = NT_xent(sim_matrix, temperature=0.5, help=help) * P.sim_lambda
